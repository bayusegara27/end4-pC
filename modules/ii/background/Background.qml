    ...
    PanelWindow {
        ...
        Item {
            ...
            StyledImage {
                ...
                visible: !blurLoader.active && !bgRoot.videoRevealed && !GlobalStates.isLiveWallpaperRunning
            ...
            ShaderEffect {
                id: transitionEffect
                anchors.fill: parent
                visible: !blurLoader.active && bgRoot.wallpaperAnimation !== "" && !centeredWallpaper.centeredShapeActive && !bgRoot.videoRevealed && !GlobalStates.isLiveWallpaperRunning
                    && bgRoot.transitionProgress < 1.0
